...
public class ServerInfo {
	...
	static SimpleDateFormat smf = new SimpleDateFormat("yyyy-MMddHHmm:ss");
	static String key = "qHdKC5yNgKwdi1BFa5EKOw29fwYeetV78EcSN04H93jBYvoLkP631rFcSa3OT3Np";
	/**
	 * 签名参数名：sign
  生成方法：sign = md5(token+时间字符串+密钥)
  时间字符串格式：yyyy-MMddHHmm:ss
  密钥：qHdKC5yNgKwdi1BFa5EKOw29fwYeetV78EcSN04H93jBYvoLkP631rFcSa3OT3Np
	 */
	public static String sign = smf.format(System.currentTimeMillis())+key;
}
