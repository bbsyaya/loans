...
public class ProductList extends BaseFragment implements OnPageChangeListener,
	...
	private void initView(View view) {
		...
		setTitleText(view, R.string.refresh, R.string.refresh,
		...
		((RadioButton) view.findViewById(R.id.btn_radio_left))
				.setOnCheckedChangeListener(this);
		((RadioButton) view.findViewById(R.id.btn_radio_center))
				.setOnCheckedChangeListener(this);
		((RadioButton) view.findViewById(R.id.btn_radio_right))
				.setOnCheckedChangeListener(this);
	}
	...
	private void glideToTab(int currentTab) {
		...
		TranslateAnimationFactory animationFactory = new TranslateAnimationFactory(
				currentPage, offset);
		Animation animation = animationFactory
				.createTranslateAnimation(currentTab);
	...
	public void onClick(View v) {
		...
		case R.id.title_btn_right:
			if (mViewPager.getCurrentItem() == 0) {
				((ProductFirst) mListPagerAdapter.getItem(mViewPager
						.getCurrentItem())).onRefresh();
			} else {
				((ProductListOthers) mListPagerAdapter.getItem(mViewPager
						.getCurrentItem())).onRefresh();
			}
			break;
