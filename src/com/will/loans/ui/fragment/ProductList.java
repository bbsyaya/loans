...
public class ProductList extends BaseFragment implements OnPageChangeListener,
    ...
    private void glideToTab(int currentTab) {
        ...
        if (animation == null) {
            //        Logger.e(this, "animation is null. primaryIndex:" + currentPage + "  targetTab:" + currentTab);
            //        Toaster.showShort(this, "animation is null. primaryIndex:" + currentPage + "  targetTab:" + currentTab);
            return;
        }
