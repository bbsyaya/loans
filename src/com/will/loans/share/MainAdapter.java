 ...
 */
public class MainAdapter extends MenuAdapter implements Callback, PlatformActionListener {
    /** "接口"分组 */
    ...
    private void initDate() {
        setGroup(GROUP_DEMO, "");
        setGroup(GROUP_MORE, menu.getResources().getString(R.string.tab_more));
    ...
    public View getItemView(SlidingMenuItem item, ViewGroup menu) {
        ...
        tvItem.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.pointer, 0);
        int dp_13 = dipToPx(menu.getContext(), 13);
        ...
        tvItem.setLayoutParams(new LinearLayout.LayoutParams(
                android.view.ViewGroup.LayoutParams.MATCH_PARENT, dp_52));
        return tvItem;
    }
