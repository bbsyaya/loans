...
import com.will.loans.getsurepassword.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements OnClickListener {
    ...
    protected enum Stage {
        ...
        Introduction(R.string.lockpattern_recording_intro_header, LeftButtonMode.Cancel,
                ...
                RightButtonMode.Ok, ID_EMPTY_MESSAGE, false), ChoiceTooShort(
                R.string.lockpattern_recording_incorrect_too_short, LeftButtonMode.Retry,
                RightButtonMode.ContinueDisabled, ID_EMPTY_MESSAGE, true), FirstChoiceValid(
                ...
                RightButtonMode.ConfirmDisabled, ID_EMPTY_MESSAGE, true), ChoiceConfirmed(
    ...
    private void updatePreviewViews() {
        ...
        for (LockPatternView.Cell cell : mChosenPattern) {
            Log.i("way",
                    "cell.getRow() = " + cell.getRow() + ", cell.getColumn() = " + cell.getColumn());
                ...
                if (mUiStage.rightMode == RightButtonMode.Continue) {
                    ...
                    if (mUiStage != Stage.HelpScreen) {
                        throw new IllegalStateException(
                                "Help screen is only mode with ok button, but " + "stage is "
                                        + mUiStage);
                    }
                    mLockPatternView.clearPattern();
                    mLockPatternView.setDisplayMode(DisplayMode.Correct);
