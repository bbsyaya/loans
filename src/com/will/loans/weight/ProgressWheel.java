...
public class ProgressWheel extends View {
    ...
    private void setupBounds() {
        ...
        rectBounds = new RectF(paddingLeft, paddingTop, getLayoutParams().width - paddingRight,
                getLayoutParams().height - paddingBottom);

        circleBounds = new RectF(paddingLeft + barWidth, paddingTop + barWidth,
                getLayoutParams().width - paddingRight - barWidth, getLayoutParams().height
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (String s : splitText) {
            ...
            canvas.drawText(s, getWidth() / 2 - offset, getHeight() / 2 + (textSize * (offsetNum))
